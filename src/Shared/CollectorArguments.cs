...
namespace SkylineNModFilter
{
    ...
    {
        public static string[] Build(bool associate, string proteomeFile, string proteomeName, bool reorder, string manifestPath, bool hasHeader, bool rename, int nameColumn, bool filterMissingness, int maximumMissingPercent, bool missingnessOnly, string missingnessScope, int groupColumn, string selectedGroup, bool excludeUnannotated)
        {
